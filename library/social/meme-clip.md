...
3. **(Optional) Animate it** — "Add a 3s zoom-and-shake meme motion to this image, keep the text static." → `atlas_generate_video` with **Seedance 2.5** i2v (`bytedance/seedance-2.0-fast/image-to-video` is plenty for memes).
